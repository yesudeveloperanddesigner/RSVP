...
const siteUrl = process.env.PAYLOAD_PUBLIC_SERVER_URL || (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : 'http://localhost:3000')

export const metadata = {
  description: 'You are cordially invited to celebrate the wedding of Cheley & Denz on June 21, 2026 at Coral Sands Beach Resort.',
